...
data_path = '/Users/cgshen/Dataset/cs246_data/nontext_features/'
...
fi1 = open(data_path + 'cool_feature', 'w')
pickle.dump(cools, fi1)
fi1.close()

fi2 = open(data_path + 'funny_feature', 'w')
pickle.dump(funnys, fi2)
fi2.close()
